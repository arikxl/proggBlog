  ...
  return (
    <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8 '>
      ...
      <div className="block lg:flex text-center items-center justify-center mb-8 w-full">
        <div className="flex items-center justify-center mb-4 lg:mb-0 w-full lg:w-auto ml-8">
          <img src={post.author.photo.url} alt={post.author.name}
            height="30px" width="30px"
            className='align-middle rounded-full' />
          <p className='inline align-middle text-gray-700 ml-2 text-lg'>{post.author.name}</p>
        </div>
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 inline ml-2 text-pink-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="text-center ">
        <Link href={`/post/${post.slug}`}>
          <span className="transition duration-500 transform
           hover:-translate-y-1 inline-block bg-pink-600 text-lg
